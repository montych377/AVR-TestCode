...
FINAL_IMAGE=${DISTDIR}/TEST_12_PWM_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/TEST_12_PWM_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=ATmega8
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/Main_PWM.o: Main_PWM.c  .generated_files/flags/default/bf8dd043596ac9ac947486ddc45fcb9a78b1ad96 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/Main_PWM.o: Main_PWM.c  .generated_files/flags/default/ffd8ec9986d2432c6ad540867a5361514c600805 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Main_PWM.o.d 
	@${RM} ${OBJECTDIR}/Main_PWM.o 
...
${DISTDIR}/TEST_12_PWM_1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "${DISTDIR}/TEST_12_PWM_1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "${DISTDIR}/TEST_12_PWM_1.X.${IMAGE_TYPE}.hex"
endif
